...
export default function FavoriteButton({ productId, productName, productPrice }: FavoriteButtonProps) {
  ...
  return (
    <div className="flex flex-col gap-3 pt-6">
      ...
      <a
        ...
        className="w-full py-4 rounded-lg font-bold text-lg transition-all cursor-pointer flex items-center justify-center gap-3 bg-[#25D366] text-white hover:bg-[#1fb855]"
      >
